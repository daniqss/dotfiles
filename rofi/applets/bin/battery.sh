...
# Battery Info
battery="`acpi -b | grep 'Battery 0' | cut -d',' -f1 | cut -d':' -f1`"
status="`acpi -b | grep 'Battery 0' | cut -d',' -f1 | cut -d':' -f2 | tr -d ' '`"
percentage="`acpi -b | grep 'Battery 0' | cut -d',' -f2 | tr -d ' ',\%`"
time="`acpi -b | grep 'Battery 0' | cut -d',' -f3`"
